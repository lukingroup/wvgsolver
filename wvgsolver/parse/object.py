...
class DielectricSliceGDSParser(ObjectGDSParser):
  ...
  This parser assumes each individual structure in the given SimulationObject's geometry is convex under the necessary 
  2D slice.
  """
  def _parse(self):
    axis_map = {}
