...
# hole_radii /= 2
# lattice_constants = np.loadtxt(os.path.join(os.path.curdir, 'examples/v0p4p2/periodStruct_3-3_wrong.txt'), dtype=float, usecols=(0), unpack=False)
# center_cell = 13
...
engine = LumericalEngine(mesh_accuracy=5, hide=False)
...
# cavity.save("v0p4p2p2_3-3_asym.obj")
...
cavity = Cavity1D(load_path="v0p4p2p2_7-3_01.obj",engine=engine)
